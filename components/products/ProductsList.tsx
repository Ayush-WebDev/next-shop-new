              ...
              <article key={index} className="group relative">
                <Link href={`/products/${id}`}>
                  <Card className="transform py-0 group-hover:shadow-xl transition-shadow duration-500">
                    <CardContent className="p-4 flex flex-row gap-8">
                      <div className="relative rounded overflow-hidden h-64 w-1/4 shrink-0">
                        <Image
                      ...
                      <div className="flex flex-col justify-start items-start text-left gap-3 pr-20">
                        <h3 className="mt-4 capitalize text-2xl">{name}</h3>
                        <p>{description}</p>
